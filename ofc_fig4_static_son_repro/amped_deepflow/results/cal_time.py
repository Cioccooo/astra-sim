...
def time_from_GEMM():
    ...
    directory = "/imec/scratch/dtpatha/patel23/DeepFlow/results/output/LLM/"
...
def main():
    ...
    # amped_dir = os.path.dirname('/imec/scratch/dtpatha/patel23/AMPeD_SID/')
    ...
    config_out_file_path = config_filename
    ...
    breakdown_out_file_path = breakdown_filename
