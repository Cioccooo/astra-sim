...
class TimeCalculation:
    def __init__(self, exp_config):
        ...
        # print(f"Thrpughput : intra = {intra_throughput} inter = {inter_throughput}")
        ...
        #print(f"Derated intra throughput = {derated_intra_throughput}")
   ...
   #     return ADD_time
    ...
    def getCf(self, m, n, k):
        ...
        if self.validating_GEMM:
            print("GEMM_time: {}, Reduction_time:{}".format(GEMM_time[0], 0))
            return GEMM_time
        else:
